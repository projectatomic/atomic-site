...
We can verify that it is still portable with Docker by starting Docker, as we did in the first tutorial. Then we can pull down the image and start the container using Docker:
