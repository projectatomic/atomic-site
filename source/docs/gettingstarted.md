...
Normally when you want to go up a container docker, uses [Docker Hub](https://hub.docker.com/) images this is the default. However, you may want your images stay on your own Infrastructure what ensures privacy, availability, speed, ease of integration, and continuous delivery.
